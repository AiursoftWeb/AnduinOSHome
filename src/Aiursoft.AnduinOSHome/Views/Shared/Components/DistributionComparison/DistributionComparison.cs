        ...
        [
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "Ubuntu 26.04 LTS · Linux 7.0",
                    "AnduinOS 2 targets Ubuntu 26.04 Resolute and ships its Linux 7.0 GA kernel. The core package retains that kernel contract through normal installs and upgrades instead of treating it as an ISO-only customization.",
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "Wayland-only · end-to-end tested",
                    "AnduinOS maintains and tests one desktop display stack end to end. Xorg session: Not included. XWayland remains available for legacy applications, but there is no Xorg desktop fallback if a Wayland-specific problem occurs.",
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.NotDocumented, "ext4-centered default",
                    "Zorin follows an ext4-centered Ubuntu 24.04 installation path. No equivalent first-party Btrfs topology and recovery ABI is enabled by default in the reviewed product scope.",
                    Source("Zorin OS technical details", ZorinDetails)),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Zorin provides recovery mechanisms, but the reviewed product scope identified no default first-party workflow connecting filesystem deployments, package transactions, boot entries and confirmation services.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.DefaultProvided, "Timeshift system snapshots",
                    ...
                    Source("Linux Mint system snapshots", MintTimeshift)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Ubuntu provides recovery mechanisms and third-party options, but the reviewed default desktop scope identified no integrated protocol connecting Btrfs deployments, APT and boot confirmation.",
                    Source("Ubuntu 26.04 release notes", UbuntuRelease))),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.Supported, "Ubuntu-derived policy",
                    "Zorin inherits the Ubuntu 24.04 memory and Swap foundation. The reviewed product scope identified no equivalent first-party virtual-memory control plane enabled by default.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.NotDocumented, "Standard memory and Swap controls",
                    "Linux Mint provides standard Linux memory and Swap capabilities. The reviewed release scope identified no default integrated Zram, Zswap, stress-test and hibernation-health interface.",
                    Source("Linux Mint 22.3 release", MintRelease)),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "All first-party graphical system tools use GTK4/libadwaita",
                    "AnduinOS first-party graphical system tools—including Installer, Control Panel, Appearance, OOBE, Driver Center, Secure Boot Toolkit, Swap Control and Snapshot Manager—share GTK4, libadwaita and adaptive conventions. This claim does not extend to third-party applications or non-graphical components.",
                    Source("AnduinOS component catalog", AnduinPackages)),
                Cell(ComparisonLevel.DefaultProvided, "Mixed first-party estate",
                    "Zorin combines GNOME applications, extensions and Zorin-specific tools from the Ubuntu 24.04 generation, resulting in a mixed first-party graphical stack rather than an all-GTK4/libadwaita control plane.",
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.DefaultProvided, "Inherited Ubuntu 24.04 stack",
                    "Linux Mint 22.3 uses the Ubuntu 24.04-era early-boot and Live generation. The reviewed scope identified no Mint-specific single-generator Dracut contract enabled by default.",
                    Source("Linux Mint 22.3 release", MintRelease)),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.Supported, "Ubuntu-derived Live persistence",
                    "Zorin provides an Ubuntu-derived Live environment. The reviewed product scope identified no equivalent first-party Dracut Live Layers and installer-source contract enabled by default.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.Supported, "Mint Live session",
                    "Mint offers a Live desktop and persistence workflows. The reviewed product scope identified no equivalent first-party Dracut overlay protocol enabled by default.",
                    Source("Linux Mint 22.3 release", MintRelease)),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.DefaultProvided, "Established installer path",
                    "Zorin offers an Ubuntu-derived graphical installation experience. The reviewed product scope identified no equivalent typed-plan and fixed semantic executor contract in its default first-party workflow.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.DefaultProvided, "Mint graphical installer",
                    "Mint provides its established graphical installer. Its default first-party workflow uses a different design from the native GTK4 planner and fixed semantic executor contract used by AnduinOS.",
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "The reviewed product scope identified no default first-party policy creating symmetric recovery points around each APT transaction.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.Supported, "Timeshift advised before upgrades",
                    ...
                    Source("Linux Mint system snapshots", MintTimeshift)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Ubuntu supports many backup and snapshot technologies, but its reviewed default desktop scope identified no automatic recovery points around every APT transaction.",
                    Source("Ubuntu 26.04 release notes", UbuntuRelease))),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "Personal Files snapshots",
                    ...
                    Source("Disk Snapshots Manager", SnapshotDesign), Source("Btrfs system design", BtrfsDesign)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "The reviewed product scope identified no default first-party personal-file snapshot history integrated with Zorin's filesystem and file manager.",
                    Source("Zorin OS technical details", ZorinDetails)),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "Capacity-aware policy + health UI",
                    ...
                    Source("Swap Control architecture", SwapDesign), Source("Installer design", InstallerDesign)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Zorin supports Linux Swap and hibernation mechanisms. The reviewed product scope identified no default first-party sizing and health-verification dashboard of this scope.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Mint exposes standard Linux Swap and hibernation capabilities. The reviewed product scope identified no integrated first-party sizing and health-verification control plane enabled by default.",
                    Source("Linux Mint 22.3 release", MintRelease)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent first-party workflow enabled by default",
                    "Ubuntu supplies the underlying kernel and installer mechanisms. The reviewed default desktop scope identified no first-party sizing and health UI with the same scope enabled by default.",
                    Source("Ubuntu 26.04 release notes", UbuntuRelease))),
            ...
            new ComparisonItem(
                ...
                Cell(ComparisonLevel.FirstClass, "Explicit zero-system-telemetry",
                    ...
                    Source("AnduinOS package architecture", AnduinPackages)),
                Cell(ComparisonLevel.NotDocumented, "No equivalent package-level policy enabled by default",
                    "The reviewed product scope identified no equivalent first-party distribution-wide package-conflict and remote-news contract. This is not a claim that Zorin profiles individual users.",
                    Source("Zorin OS technical details", ZorinDetails)),
                Cell(ComparisonLevel.DefaultProvided, "Privacy-oriented defaults",
                    "Linux Mint publishes privacy-oriented defaults. The reviewed scope identified no equivalent package-level conflict and replacement contract for every Ubuntu reporting component.",
                    Source("Linux Mint 22.3 release", MintRelease)),
            ...
            new ComparisonItem(
                "acceptance", "test-tube-diagonal", "Public automated release evidence", "Published boot, install, reboot and desktop reports", false,
                Cell(ComparisonLevel.FirstClass, "QEMU / QMP / AT-SPI reports published",
                    "The published black-box framework boots real ISOs, drives the GTK installer through semantic accessibility data and QEMU input, reboots the installed system and records screenshots, serial logs and contract evidence.",
                    Source("AnduinOS ISO acceptance framework", AnduinIso)),
                Cell(ComparisonLevel.DefaultProvided, "No comparable public suite identified as of 2026-08-28",
                    "Zorin performs release engineering and quality assurance. No comparable distribution-level public suite publishing installer and desktop acceptance evidence was identified in the stated official research scope as of 28 August 2026. This compares public evidence; it does not imply that Zorin does no QA.",
                    Source("Zorin OS 18.1 details", ZorinDetails)),
                Cell(ComparisonLevel.DefaultProvided, "Release QA",
                    "Mint performs release and ISO quality assurance, including fully QA-tested HWE images. The reviewed public scope identified no acceptance contract directly comparable to the published AnduinOS QEMU/QMP/AT-SPI framework.",
